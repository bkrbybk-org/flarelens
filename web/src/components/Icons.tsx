...
/**
 * AI Gateway sits between callers and models, so it is drawn as a routing point rather than a
 * second sparkle: it used to share SparkIcon with Workers AI, and two sections with one icon
 * makes the icon useless for telling them apart.
 */
export const RouteIcon = (p: IconProps) => (
	<svg {...base(p)}><circle cx="5" cy="19" r="2.5" /><circle cx="19" cy="5" r="2.5" /><path d="M5 16.5V9a4 4 0 0 1 4-4h2M19 7.5V15a4 4 0 0 1-4 4h-2" /></svg>
);

/** Cost, for the same reason: it shared ChartIcon with Access Usage. */
