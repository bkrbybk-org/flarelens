...
import { MAX_GATEWAY_RANGE_MS, GatewayUsageError, fetchGatewayUsage, isGatewayGranularity } from "../lib/gateway-usage";
import { parseInstant } from "../lib/workers-analytics";
import { validHexId } from "../http";
import type { App } from "../env";

export function registerGatewayRoutes(app: App): void {
